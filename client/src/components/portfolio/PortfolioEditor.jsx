...
export default function PortfolioEditor() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-obsidian)] flex flex-col print:bg-white print:min-h-0 print:block">
      ...
      {/* Simple Toast Notification — NO backdrop-blur, NO full-screen overlay */}
      {toast.show && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 print:hidden" style={{ animation: 'fadeInUp 0.3s ease' }}>
